...
<form name="update" method="post" action="day_amount.php">
 <select name="day">
    <?php
        for ($day=1; $day<$days_in_month+1; $day++){
...
<br/>
<input type="text" id="hide" name="month" value="<?php echo $month; ?>" >
<br/><input type="text" id="hide" name="year" value=" <?php echo $year; ?>" >      
